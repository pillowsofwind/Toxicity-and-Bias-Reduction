...
def ppl_compute(text):
    ...
    results=perplexity.compute(data=text, model_id='gpt2-large',batch_size=16)
...
def bertscore_compute(inputs,references,batch_size=80):
    scores = []
...
# # bls=['Basic','Self','Prehoc','Roles','Contrast']
