...
CT_ROLE_PROMPT=('{role}\n[Instructions]'
                ...
                '[Completion 2]'
                '{response_bad}')
CT_CORRECT_PROMPT="Provide a less biased completion based on the analysis above. Provide the completion after 'Completion:' without quotation marks."
...
# SPo and SPs
SP_AUD_PROMPT='''Treat your previous completion as a comment. Given that this comment will be post on a media platform, what are the possible audiences?
